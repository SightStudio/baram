...
.switch-field input + p { border: 1px solid rgba(0, 0, 2, 0.2); padding: 0.6rem 0.8rem; background-color: rgb(55, 69, 82); color : #ffffff; font-weight: bold; font-size: 0.7rem;}
.switch-field input:checked + p { background-color: rgb(1, 195, 255); box-shadow: none; color : #ffffff; font-weight: bold; font-size: 0.7rem; }
